...
# ==========================================
# IMPORTANTE: Añade json_repair si lo estás usando en el código
# ==========================================
import json_repair 

# ==========================================
# IMPORTANTE: Importamos TODAS las funciones necesarias de utils.py
# ==========================================
from utils import (
    consultar_ollama,
    cargar_variables_desde_json,
    obtener_config_variable,
    generar_prompt_dinamico,
    BloqueAnalisisLenguajeSexista,
    BloqueAnalisisBinario,
    NombresDetectados,
    CitaTitularValidada,
    ProtagonistasDetectados,
    GeneroPeriodistaValidado,
    TemaConExplicacion,
    IaTemaCentralConExplicacion,
    IaSignificadoConExplicacion,
    MencionIaConExplicacion,
    ReferenciaPoliticasGeneroConExplicacion,
    DenunciaDesigualdadConExplicacion,
    MujeresRacializadasConExplicacion,
    MujeresConDiscapacidadConExplicacion,
    MujeresGeneracionalidadConExplicacion,
    FotografiasValidadas,
    FuentesValidadas
)
...
def clasificar_var_cita_titular(titulo: str, modelo: str = "gemma3:4b") -> CitaTitularValidada:
    ...
    respuesta = consultar_ollama(prompt, modelo)

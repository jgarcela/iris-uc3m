...
description: Metodología para clasificar «sexismo_discurso» (V30) en un artículo. Cárgala antes de emitir el veredicto de esta variable.
...
Clasifica **`sexismo_discurso`** a nivel de documento.
...
1. «Solo 2 de los 22 miembros del Consejo son mujeres, un dato que evidencia la brecha que persiste en los órganos de poder corporativo»
   Por qué NO es {nombre}: Mismo dato que el primer ejemplo positivo, pero AQUÍ se enmarca explícitamente como brecha problemática. Esto es V17 (denuncia), no V30.
   Si activa otra cosa, sería: V17
2. «La ministra de Defensa presentó el nuevo plan estratégico ante el Congreso»
   Por qué NO es {nombre}: Hecho informativo sin asimetrías presentadas, sin estereotipo, sin naturalización. Es una noticia neutra.
3. «El estudio del INE muestra que la brecha salarial se redujo dos puntos respecto al año anterior»
   Por qué NO es {nombre}: Reporta la asimetría como dato medido en un contexto de seguimiento, no la legitima.

## Caso límite documentado
Texto difícil: «El Papa Francisco recibió en audiencia a la familia real»
Decisión: NO es V30
...
- **v25_lenguaje_sexista:** V25 trata el cómo se DICE (palabras). V30 trata el qué se CUENTA (realidad). Pueden coexistir o no.
- **v17_denuncia_desigualdad:** V17 y V30 son polos opuestos sobre el mismo material. Si el texto DENUNCIA la asimetría → V17. Si la NORMALIZA o la describe como hecho natural → V30. Un texto bien escrito sobre desigualdad puede activar V17 y NO V30.
- **v31_androcentrismo:** V31 sitúa al varón como centro/referente. V30 describe asimetrías de poder. V31 es un MECANISMO; V30 es el CONTENIDO. Una noticia que solo cita expertos varones es V31; una noticia que dice 'las mujeres prefieren X por su naturaleza' es V30.

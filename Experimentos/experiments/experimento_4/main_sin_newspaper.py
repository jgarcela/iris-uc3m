...
FOLDER = "../../results"
PREFFIX = "4-Experimento-4_03_2026"
SUFFIX = "scrape"
...
def procesar_fila(row):
    ...
    np_titular = variables.clasificar_var_nombre_propio_titular_list_e3(titulo=titulo, modelo='llama3.1:8b')
    ...
    protas = variables.clasificar_var_cla_genero_prota_list_e3(texto_noticia=texto, modelo='llama3.1:8b')
    ...
    resultados['modelo_genero_periodista'] = variables.clasificar_var_genero_periodista_e3(nombre_periodista=nombre_periodista, nombre_medio=nombre_medio, modelo='llama3.1:8b')

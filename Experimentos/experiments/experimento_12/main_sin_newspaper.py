...
def procesar_fila(row):
    ...
    np_titular = variables.clasificar_var_nombre_propio_titular_list_e1(titulo=titulo, modelo='gemma4:e4b')
    ...
    protas = variables.clasificar_var_cla_genero_prota_list_e1(texto_noticia=texto, modelo='gemma4:e4b')
    ...
    resultados['modelo_genero_periodista'] = variables.clasificar_var_genero_periodista_e1(nombre_periodista=nombre_periodista, nombre_medio=nombre_medio, modelo='gemma4:e4b')

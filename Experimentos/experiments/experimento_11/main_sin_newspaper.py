...
FOLDER = "../../results"
PREFFIX = "11-Experimento-11_03_2026"
SUFFIX = "scrape"
...
def procesar_fila(row):
    ...
    np_titular = variables.clasificar_var_nombre_propio_titular_list_e1(titulo=titulo, modelo='claude-opus-4-7')
    ...
    protas = variables.clasificar_var_cla_genero_prota_list_e1(texto_noticia=texto, modelo='claude-opus-4-7')
    ...
    resultados['modelo_genero_periodista'] = variables.clasificar_var_genero_periodista_e1(nombre_periodista=nombre_periodista, nombre_medio=nombre_medio, modelo='claude-opus-4-7')

...
Más allá de cada tabla, los resultados del Capítulo~\ref{results_and_discussion} admiten una lectura de conjunto
...
herramienta, que encabeza siete de las veinte celdas, más que ninguna otra, y prescinde del
componente más caro en tiempo de cómputo, con un coste en dólares que apenas
difiere del de las demás configuraciones (Sección~\ref{subsec:iris_coste}). No es, con todo, una opción imbatible, ya que queda
...
La primera es un \textbf{límite de la tarea}. Con la prudencia obligada pues no hay anotaciones múltiples de cada pieza, vemos que dos equipos expertos codificaron la
misma variable con desempeños muy distantes en términos de detección, hasta el punto de que
\texttt{sexismo\_discurso} pasa del 11,4\,\% al 65,2\,\% de piezas marcadas según
...
según quién codifique, un rango de 69,5 puntos que por sí solo supera a los 53,8 que
separan a los dos equipos, de modo que dos personas con el mismo
...
anterior. En \texttt{lenguaje\_sexista} cada equipo marca la variable en la mayoría de
sus piezas, el 75,0\,\% y el 85,5\,\% respectivamente, y
aun así tres de los cuatro modelos presentan un \textit{recall} prácticamente nulo. Ahí no
hay criterio en disputa, hay un fenómeno que las personas ven y el sistema no. El
caso examinado en la Sección~\ref{subsec:iris_caso} muestra uno de los posibles mecanismos, ya que
...
dos equipos distan 53,8 puntos. En \texttt{lenguaje\_sexista} y
...
marca alrededor del doble que el otro, si bien esto ocurre sobre proporciones tan bajas que el
obstáculo principal no es el desacuerdo sino la escasez de positivos, 81 y 131 piezas
en todo el corpus.

Conviene, por ello, no dejar que el techo de la tarea oscurezca la necesidad de mejorar el sistema. En el nivel
desplegado, el mejor \textit{recall} que alcanza alguno de los cuatro modelos se queda en 0,450
...
modelos sigue siendo amplio independientemente de cuánto se estabilice el criterio de anotación.
...
otra consiste en mejorar la sensibilidad del sistema en las variables en las que las
expertas marcan el fenómeno de forma mayoritaria con independencia de quién anote. Conviene además evitar una simplificación, ya que
...
que alcanza el mayor acuerdo del Capítulo~\ref{results_and_discussion}, y 6,89 USD con \texttt{gpt-4o-mini}, que
...
pedirle a una decisión de despliegue. Por este motivo, no es sencillo inferir qué podría ocurrir con el resto de las variables no contempladas en este trabajo.
...
humanas, ya que en nueve de ellas la precisión o el \textit{recall} caen por debajo de 0,5.
...
supone unos segundos de descarte para el o la analista mientras que un falso negativo
...
elevar el \textit{recall} aun a costa de la precisión. La Sección~\ref{subsec:iris_equipo_ia}
apunta una vía concreta en ese sentido, la de marcar la pieza cuando lo haga
cualquiera de los modelos, que eleva el \textit{recall} en las cinco variables. Tiene dos
...
de las evidencias, por no disponer de un marcado cualitativo experto con el que contrastarlas

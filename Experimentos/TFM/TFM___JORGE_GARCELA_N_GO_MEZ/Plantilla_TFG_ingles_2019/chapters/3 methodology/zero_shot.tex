...
Por cada pieza y variable, el modelo devuelve un objeto en notación de objetos de
JavaScript (\textit{JavaScript Object Notation}, JSON por sus siglas en inglés) con
tres campos:
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.1\textwidth]{Plantilla_TFG_ingles_2019/imagenes/salida_trazabilidad_blanco.pdf}%
}
  \caption{Salida estructurada y trazable de una predicción. Fuente: elaboración propia con ayuda de Claude (Anthropic).}

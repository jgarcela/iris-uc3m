...
\begin{table}[H]
    ...
    \ttabbox[\FBwidth]{
        ...
        \begin{tabular}{@{}l l c >{\columncolor{gray!15}}c@{}}
            \toprule
            \textbf{Cód.} & \textbf{Variable} & \textbf{Prevalencia de \textit{Sí}} & \textbf{Exactitud trivial} \\
            \midrule
...
detecte nada y responda siempre \textit{No} acertaría el 93,8\,\% y el 90,0\,\% de las

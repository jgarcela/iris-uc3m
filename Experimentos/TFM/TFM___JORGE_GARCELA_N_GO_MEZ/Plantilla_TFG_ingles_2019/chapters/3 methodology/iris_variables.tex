...
El libro de códigos del proyecto define quince variables de sexismo lingüístico,
...
El alcance de este trabajo se restringe a cinco variables (V25, V26, V30, V33 y
V35), seleccionadas por el equipo experto del proyecto atendiendo a dos
criterios: su relevancia teórica dentro del marco de análisis y su frecuencia de
aparición en el corpus, que garantiza un número de casos suficiente para una
evaluación con sentido estadístico. Las diez variables restantes permanecen como
...
Las cinco variables seleccionadas se definen del modo siguiente:
...
tal como se analiza en la Sección~\ref{subsec:iris_divergencia}. Mientras V25 y
V26 presentan una prevalencia del 81\,\% de casos positivos, V33 y V35 se
sitúan en el 6,2\,\% y el 10,0\,\% respectivamente.

Esta circunstancia implica que un clasificador trivial que respondiese siempre
con la clase mayoritaria alcanzaría exactitudes de 0,810 en V25 y V26, y de
0,938 y 0,900 en V33 y V35. Por consiguiente, \textbf{la exactitud no constituye
por sí sola una métrica informativa} en esta tarea, y todos los resultados de
este trabajo se acompañan del coeficiente $\kappa$ de Cohen —que descuenta el
acuerdo esperable por azar— y de la prevalencia de referencia.

\subsubsection{De la definición experta a la especificación ejecutable}

Para su empleo por sistemas automáticos, cada variable se formaliza en una
especificación estructurada que recoge, además de la definición conceptual: un
criterio operativo de decisión, una metodología paso a paso, ejemplos positivos
y contraejemplos comentados, casos límite documentados y las fronteras que la
separan de las variables contiguas. Esta especificación constituye la fuente

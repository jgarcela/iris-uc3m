...
de las guías. La implementación es deliberadamente ligera: un índice de frecuencia
de término-frecuencia inversa de documento (\textit{Term Frequency-Inverse Document
Frequency}, TF-IDF por sus siglas en inglés)~\cite{sparckjones1972} en memoria sobre
...
propuesta. En ausencia de la herramienta, la relación entre el agente y las guías
...
vínculo directo y verificable: el agente recupera texto literal de las fuentes en

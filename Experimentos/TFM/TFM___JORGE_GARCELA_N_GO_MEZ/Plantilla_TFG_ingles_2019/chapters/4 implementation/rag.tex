...
recuperación (\textit{Retrieval-Augmented Generation}, RAG) sobre el texto real
...
conexión con las guías sería solo conceptual, y afirmar que «el agente se apoya en
las guías expertas» sería inexacto. Con \texttt{CONSULTAR\_GUIA}, esa afirmación
...
bien para términos precisos, como «masculino genérico» o «feminización de
...
alcance de este trabajo, el índice léxico captura la mayor parte de las consultas
útiles. Cuestión distinta es si esa recuperación mejora el acuerdo final: su

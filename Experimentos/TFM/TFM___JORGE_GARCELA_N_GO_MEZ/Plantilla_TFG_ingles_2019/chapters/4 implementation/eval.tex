...
\paragraph{Coeficiente $\kappa$ de Cohen.} Mide el acuerdo entre dos personas anotadoras
...
identificador (Sección~\ref{sec:llms_models}). Para los modelos comerciales,

%----------
%	RESULTADOS: introducción del capítulo
%----------
...
clasificación de las cinco variables de lenguaje sexista del corpus definido en el
Capítulo~\ref{sec:methodology}. Describe el diseño experimental y presenta los
resultados sobre las 1.313 noticias con anotación experta, variable a variable. Su
lectura transversal, las implicaciones para el proyecto IRIS y la aplicabilidad
editorial del sistema se abordan en el Capítulo~\ref{discussion_chapter}.

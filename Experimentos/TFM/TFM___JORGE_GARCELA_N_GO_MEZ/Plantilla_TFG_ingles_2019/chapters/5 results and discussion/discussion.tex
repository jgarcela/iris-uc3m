...
discriminativa. Este trabajo lo ilustra en dos celdas opuestas
(Tablas~\ref{tab:var-v25} y~\ref{tab:var-v33}), la de un modelo que se vuelve menos
conservador y la de otro que se vuelve mucho más, ya que en ambas la exactitud mejora
al acercarse el modelo a la clase mayoritaria sin que su recall lo acompañe:

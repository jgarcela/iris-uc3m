...
(Sección~\ref{subsec:iris_local}). Encabeza \texttt{asimetria\_mujer\_hombre} en recall
y en precisión, si bien no conviene apoyarse en ese dato, porque su ventaja sobre el
segundo es de una sola pieza acertada. El respaldo firme está en
\texttt{masc\_generico}, donde queda segundo con un recall de 0,408 frente al 0,206 y
el 0,104 de los dos modelos de OpenAI. Para una institución que maneja material sujeto

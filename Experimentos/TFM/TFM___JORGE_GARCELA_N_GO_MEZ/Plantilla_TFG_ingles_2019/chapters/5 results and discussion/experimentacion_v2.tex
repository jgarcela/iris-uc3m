...
$\kappa = 0,261$), si bien la variante sin RAG queda a dos milésimas (0,618) con un
$\kappa$ ligeramente superior (0,264). En \texttt{sexismo\_discurso} (V30) la mejor
combinación es \texttt{gpt-5.4-nano} con \textit{skills} y RAG (F1 de 0,271 frente

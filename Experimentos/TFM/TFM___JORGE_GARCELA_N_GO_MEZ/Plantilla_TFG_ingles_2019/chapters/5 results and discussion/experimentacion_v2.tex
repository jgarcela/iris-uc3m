...
$\kappa$ sube de 0,073 a 0,261 y su recall de 0,287 a 0,733, con la exactitud
acompañando (de 0,397 a 0,708). Es la única celda del capítulo en que las tres
métricas se mueven a la vez en la dirección esperada, lo que descarta que la
mejora responda a un artefacto de la distribución. En
\texttt{asimetria\_mujer\_hombre} (V33) el modelo local mejora también con B1, con
un $\kappa$ que pasa de 0,054 a 0,092 y un recall de 0,136 a 0,160.
...
\texttt{denominacion\_sexualizada} (V35), donde el $\kappa$ cae de 0,123 a 0,014 en
\texttt{gpt-5.4-nano}, de 0,136 a 0,061 en \texttt{gpt-4o-mini} y de 0,154 a 0,015
en \texttt{gemma4:e4b}.
...
\begin{table}[H]
    ...
    \ttabbox[\FBwidth]{
        ...
        tres modelos accesibles por API, y mejor acuerdo alcanzado en el nivel B1 por
        cualquiera de los cuatro modelos.}
        \label{tab:iris-coste-var}
    }{
        \begin{tabular}{@{}l l c c >{\columncolor{gray!15}}c@{}}
            \toprule
            \textbf{Cód.} & \textbf{Variable} & \textbf{B0 (USD)} & \textbf{B1 (USD)} & \textbf{Mejor} \boldmath$\kappa$ \textbf{(B1)} \\
            \midrule
            V25 & \texttt{lenguaje\_sexista}         & 2,86 & 7,48 & 0,015 \\
            V26 & \texttt{masc\_generico}            & 2,72 & 6,82 & \textbf{0,261} \\
            V30 & \texttt{sexismo\_discurso}         & 2,80 & 5,18 & 0,011 \\
            V33 & \texttt{asimetria\_mujer\_hombre}  & 2,83 & 6,01 & 0,092 \\
            V35 & \texttt{denominacion\_sexualizada} & 2,61 & 5,42 & 0,061 \\
            \midrule
            & \textbf{Total} & \textbf{13,83} & \textbf{30,91} & \textemdash \\
            \bottomrule
        \end{tabular}
    }
    \endgroup
...
El contraste con la última columna es el dato relevante para el proyecto.
\texttt{lenguaje\_sexista} es la variable más costosa de las cinco y su mejor
acuerdo apenas se distingue del azar, mientras que \texttt{masc\_generico} cuesta
algo menos y concentra prácticamente todo el acuerdo obtenido. Dicho de otro modo,

...
en una tarea con clases fuertemente desequilibradas, la exactitud es un indicador
...
Skills mejoran el sistema para todos los modelos, y se equivocaría}. De ahí la recomendación de reportar
siempre exactitud, $\kappa$ y prevalencia de forma conjunta en tareas de
clasificación desequilibradas.
...
\begin{table}[H]
    ...
    \scriptsize
    \ttabbox[\FBwidth]{
        \caption{Descomposición de la arquitectura por componentes. $\kappa$ promedio sobre las cinco variables, por modelo ($N=1.313$)}
...
\begin{table}[H]
    ...
    \scriptsize
    \ttabbox[\FBwidth]{
        \caption{Descomposición de la arquitectura por componentes. \textbf{Exactitud} promedio sobre las cinco variables, por modelo ($N=1.313$)}
...
\begin{table}[H]
    ...
    \scriptsize
    \ttabbox[\FBwidth]{
        \caption{Descomposición de la arquitectura por componentes. \textbf{F1 macro} promedio sobre las cinco variables, por modelo ($N=1.313$)}
...
\begin{figure}[H]
    ...
    \caption{Coeficiente $\kappa$ promedio al activar cada componente, por modelo
...
\begin{itemize}
    ...
    genérica del bloque (el uso discriminatorio del lenguaje por razón de sexo, sin
    describir un mecanismo concreto), las anotadoras, que son expertas en detectar este tipo de lenguaje, son capaces de encontrarlo en casi todas las piezas, de ahí su prevalencia del
    ...
    donde un equipo la marca casi seis veces más que el otro como veremos más adelante
...
examina en la Sección~\ref{subsec:iris_errores} para dirimir si es una
limitación de los modelos o de la propia tarea. Otra característica que observamos es el comportamiento dispar de los modelos respecto a las variables analizadas.
...
Indexa es sistemáticamente superior al obtenido con UC3M, en los cuatro modelos y en
...
ocho puntos, mientras que contra UC3M el $\kappa$ cae hacia el azar (llega a valores
...
$\kappa$ entre evaluar contra Indexa y contra UC3M (de 0,118 a 0,043, un rango de
...
UC3M en el 65,2\,\%, casi seis veces más. No es ruido del modelo, son dos criterios
...
\begin{table}[H]
    ...
    \ttabbox[\FBwidth]{
        ...
        \begin{tabularx}{\textwidth}{
            ...
            \normalfont\textbf{Variable} & \textbf{Indexa} & \textbf{UC3M} & \textbf{Ratio} & \textbf{Indexa} & \textbf{UC3M} \\
            \midrule
...
equipo de anotación, junto a Indexa y UC3M.
...
\begin{table}[H]
    ...
    \ttabbox[\FBwidth]{
        ...
        \begin{tabularx}{\textwidth}{
            ...
            UC3M 6 & 1 & 1,000 & 0,000 & 1,000 & 0,000 & 0,000 & 0,400 \\
...
por encima de todas las anotadoras salvo una (UC3M-4, con el 27,1\,\%). También
...
distintos que solo coinciden en sus limitaciones de detección. El modelo local \texttt{gemma4:e4b}
...
ambigüedad de algunas definiciones del libro de códigos. El coeficiente $\kappa$ mide, en

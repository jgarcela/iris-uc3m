...
La primera se deriva directamente del principal hallazgo. En las variables cuyo
criterio los equipos interpretan de forma más dispar, donde el desacuerdo mide distancia
de criterio tanto como error, tiene poco sentido seguir tratándolas como si tuvieran una
única interpretación correcta. Resultaría prometedor explorar
...
Por último, en el plano de la aplicación, el sistema está ya integrado en la
herramienta web del proyecto IRIS (Sección~\ref{poc}), y el paso siguiente es validar
esa integración con estudios de uso con profesionales de redacciones reales, que son

...
un techo de la propia tarea, visible allí donde el criterio experto admite lecturas muy
distantes, como en \texttt{sexismo\_discurso}, que dos equipos marcan en el 11,5\,\% y
en el 65,2\,\% de las piezas. La otra es una limitación de los modelos, que en
\texttt{lenguaje\_sexista} dejan sin señalar casi todo lo que ambos equipos coinciden en
marcar. El peso de cada una cambia según la variable, y ninguna absuelve a la otra, de
manera que el desacuerdo mide a la vez distancia de criterio y error de detección. Cabe
precisar, además, que los cuatro modelos quedan por debajo de la persona que menos
marca, esto es, fuera del rango humano, lo que no expresa un criterio alternativo más
permisivo sino una capacidad de detección menor. La cuarta es que un modelo local
de pesos abiertos, \texttt{gemma4:e4b}, compite variable a variable con los servicios
comerciales accesibles por API, a los que supera en \texttt{asimetria\_mujer\_hombre} y
adelanta en \texttt{masc\_generico}, preservando la privacidad del material y sin
tarifas de inferencia, a cambio de trasladar el coste al tiempo de cómputo. Esta comparación sobre la misma tarea y el mismo corpus con un flujo de procesamiento agnóstico a la empresa

...
\begin{table}[H]
    \ttabbox[\FBwidth]{
        ...
        \begin{tabular}{p{3cm} p{11cm}}
            ...
            Capítulo 5: Resultados & Presenta los resultados de la evaluación variable a variable: las métricas de cada modelo en los dos niveles, la descomposición de la arquitectura por componentes, el coste de inferencia y el modelo local, y el origen de la infradetección. \\ \hline
            
            Capítulo 6: Discusión & Lee los resultados de forma transversal, reparte el desajuste entre el límite de la tarea y el de los modelos, extrae las implicaciones para IRIS y examina la aplicabilidad editorial mediante la integración en la herramienta del proyecto. \\ \hline
            
            Capítulo 7: Conclusiones y Líneas Futuras & Sintetiza los hallazgos principales de la investigación, reflexiona sobre el cumplimiento de los objetivos y propone futuras vías de desarrollo y aplicación. \\ \hline

...
\begin{itemize}
    ...
    \item \textbf{PT3. Representación y recuperación de información}
    \begin{itemize}
    ...
    \begin{itemize}
        \item Prueba de concepto sobre la herramienta web de IRIS\_IAMEDIA.
...
\begin{figure}[H]
 ...
 {Cronograma de trabajo (diagrama de Gantt). Fuente: elaboración propia con ayuda de Claude (Anthropic).}}

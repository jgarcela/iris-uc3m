...
\begin{figure}[H]
    \centering
    \includegraphics[height=2cm]{Plantilla_TFG_ingles_2019/imagenes/impulsa_rtve.jpeg}
    \caption{Ayuda Impulsa Visión RTVE a la investigación para Trabajos Fin de Máster, en la línea de inteligencia artificial y periodismo.}
    \label{fig:impulsa-vision}
\end{figure}
...
disciplina correspondiente. Es el caso de \textit{codebook}, por ejemplo, que aquí aparece
...
la literatura, como \textit{zero-shot}, que cuenta con equivalente en español,
aprendizaje nulo, pero cuya forma inglesa es la que permite localizar los trabajos
que lo emplean.

Las tablas siguientes recogen los términos y acrónimos empleados, con su equivalencia
y una breve nota sobre el criterio aplicado.
...
\begin{table}[H]
    ...
    \ttabbox[\FBwidth]{
        ...
        \begin{tabularx}{\textwidth}{
            ...
            \textit{gold standard} & Estándar de referencia & Sinónimo de \textit{ground truth} en la literatura. Se emplea la forma española \\
            ...
            \textit{Markdown} & --- & Formato de fichero de texto plano que marca la estructura del documento con convenciones sencillas. Se conserva por ser el nombre propio del formato \\
            \textit{Ollama} & --- & Programa que ejecuta modelos de lenguaje en infraestructura propia. Se conserva por ser el nombre propio de la herramienta \\
            ...
            \textit{tool-calling} & Llamada a herramientas & Mecanismo nativo de algunas proveedoras para invocar funciones \\
            ...
            \textit{zero-shot} & Aprendizaje nulo & Régimen en que el modelo resuelve la tarea sin ejemplos resueltos en la instrucción y sin ajustar sus parámetros \\
            \bottomrule
        \end{tabularx}
    }
    \endgroup

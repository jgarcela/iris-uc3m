...
**Soporte a la reflexión.** La estructura de la memoria, el orden de los capítulos y el enfoque de la discusión los he decidido yo, con mis tutoras. A la herramienta le he pedido que analizara las consecuencias de decisiones que ya había tomado: por ejemplo, cuando decidí retirar una sección de síntesis con métricas promediadas, le pedí que localizara qué referencias cruzadas y qué tablas dependían de ella para no dejar nada roto. Cuando recibí los comentarios de mis tutoras, le pedí que los contrastara con los datos para tener esa comprobación delante antes de decidir cómo responder a cada uno.

**Revisión o reescritura de párrafos redactados previamente.** *La he usado para refinar la redacción de texto que ya había escrito, no para redactarlo en mi lugar. Sobre todo en los capítulos de resultados y conclusiones y en el resumen. Le pedía que revisara párrafos míos, que aplicara unas reglas de estilo que fijé al principio (registro académico, siglas en inglés desarrolladas en su primera aparición, fechas en un formato único, uso coherente del femenino para "la agente").*
...
**Glosario.** Me ayudó a revisar el glosario de términos en inglés y de acrónimos, comprobando contra el texto de la memoria qué términos se usaban realmente y cuáles faltaban o sobraban.
...
**Tratamiento de datos.** Ha sido el uso más útil. Todos los datos del trabajo (el corpus, las anotaciones expertas y las predicciones de los cuatro modelos evaluados) se han obtenido experimentalmente; en ningún caso he usado IAG para generar datos. La herramienta los ha procesado: recalcular desde los datos crudos las cifras que cito en la memoria, comprobar que las afirmaciones del texto las sostienen, y ejecutar análisis complementarios que le pedía, como la dispersión de la anotación entre personas o la combinación de varios modelos. Cada resultado lo he revisado yo antes de incorporarlo, y los principales se han contrastado con mis tutoras.

**Inspiración de ideas.** Algunas propuestas de análisis complementario surgieron en la conversación con la herramienta, como mirar la dispersión de la anotación persona a persona además de por equipos, y las incorporé después de verificarlas yo con los datos. La estructura y los contenidos de la memoria no los he pedido a la herramienta.
...
Lo que más me ha servido no ha sido escribir, sino comprobar, y tenerla como asistente durante todo el proceso. Un trabajo con cinco variables, cuatro modelos y varias configuraciones produce cientos de cifras, y mantenerlas coherentes entre tablas, texto y conclusiones es difícil de hacer a mano, y llevaría bastante tiempo. Con la IA podía recalcularlas todas desde los datos y obtener cuáles no cuadraban o qué afirmaciones iban más allá de lo que los datos permitían. Otra ayuda que no esperaba tanto ha sido la de mantener al día la documentación de trabajo: una lista de tareas pendientes con fechas, las notas de las reuniones con mis tutoras y el seguimiento de sus comentarios hasta cerrarlos, y un registro de lo que iba cambiando en cada sesión. Con un trabajo de meses y muchas versiones, eso me ha evitado perder cosas por el camino. También me ha ayudado a mantener la coherencia del documento entero. Cuando mis tutoras me pidieron cambiar ciertos enfoques, había cambios que tocaban varias secciones de la memoria y me permitió poder detectar rápidamente si me había dejado algo sin cambiar. En cuanto a las conclusiones, me ha servido más para descartar que para producir: varias de mis primeras versiones eran demasiado rotundas, y fue el contraste con los datos el que me obligó a matizarlas.

En cuanto a las debilidades, la principal es que comete errores y los presenta con la misma seguridad que los aciertos. Ha habido ocasiones en las que una cifra o una referencia no era correcta y solo lo he sabido porque la he contrastado. Otra es la tendencia a las conclusiones rotundas: si no se le frena, convierte una diferencia pequeña en un hallazgo, y en un trabajo como este, con métricas frágiles y muestras desequilibradas, eso puede llevar a afirmar más de lo que los datos permiten. También he notado que, en cambios que tocan varias partes del documento, a veces arregla una cosa y descoloca otra, y que en sesiones largas pierde el hilo de decisiones anteriores y hay que volver a explicárselas. Y hay un riesgo más personal: la comodidad de tener una respuesta inmediata invita a delegar el criterio, y creo que la única forma de que no ocurra es no incorporar nada a la memoria sin leerlo, entenderlo y contrastarlo antes, que es lo que he intentado hacer.

En general, me ha servido en todo el desarrollo y el proceso de este TFM para entender nuevos conceptos, detectar errores de redacción, mantener la coherencia de la memoria y trabajar con un asistente "24h al día" que me permitía seguir aprendiendo de una manera muy sencilla y cómoda.
...
o.write(r"""\begin{table}[H]
    ...
    \ttabbox[\FBwidth]{
        ...
        \begin{tabularx}{\textwidth}{
            >{\hsize=1.66\hsize\raggedright\arraybackslash}X
            >{\hsize=0.71\hsize\centering\arraybackslash}X
            >{\hsize=1.14\hsize\centering\arraybackslash}X
            >{\hsize=0.71\hsize\centering\arraybackslash}X
            >{\hsize=0.71\hsize\centering\arraybackslash}X
            >{\hsize=1.51\hsize\centering\arraybackslash}X
            >{\hsize=0.71\hsize\centering\arraybackslash}X
            >{\hsize=0.85\hsize\columncolor{gray!15}\centering\arraybackslash}X
        }
            \toprule

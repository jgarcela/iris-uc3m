"""
Experimento 19 adaptado para el cluster TSC (fase CLIENTE).
...
pero el experimento_19 compara MODELOS DE API además del Ollama local. Como
...
# ==========================================
def parse_args():
    p = argparse.ArgumentParser(description="Experimento 19 - cliente cluster (sharded, multi-proveedor)")
...
PREFFIX = "19-Experimento-19_03_2026"

"""
Experimento 18 bis adaptado para el cluster TSC (fase CLIENTE).
...
# ==========================================
def parse_args():
    p = argparse.ArgumentParser(description="Experimento 18 bis - cliente cluster (sharded, multi-proveedor)")
...
PREFFIX = "18bis-Experimento-18bis_03_2026"

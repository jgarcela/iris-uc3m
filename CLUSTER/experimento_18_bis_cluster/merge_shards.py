"""Junta los CSV por shard del experimento_18 en un único resultado final."""
import glob
import os
import sys
...
patron = os.path.join(output_dir, "18bis-Experimento-18bis_03_2026_resultados_modelo_2024_scrape_shard*de*.csv")
...
salida = os.path.join(output_dir, "18bis-Experimento-18bis_03_2026_resultados_modelo_2024_scrape_FULL.csv")

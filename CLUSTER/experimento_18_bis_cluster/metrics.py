...
Por defecto lee results/18bis-Experimento-18bis_03_2026_resultados_modelo_2024_scrape_FULL.csv
...
DEFAULT_INPUT = os.path.join(
    BASE_DIR, "results",
    "18bis-Experimento-18bis_03_2026_resultados_modelo_2024_scrape_FULL.csv",
)

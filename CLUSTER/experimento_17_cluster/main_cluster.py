"""
Experimento 17 adaptado para el cluster TSC (fase CLIENTE).
...
# ==========================================
def parse_args():
    p = argparse.ArgumentParser(description="Experimento 17 - cliente cluster (sharded, multi-proveedor)")
...
PREFFIX = "17-Experimento-17_03_2026"

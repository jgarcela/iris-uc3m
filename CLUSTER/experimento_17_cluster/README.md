# Experimento 17 (cluster) — comparativa multi-modelo de las 5 variables de sexismo
...
CLI=CLUSTER/experimento_17_cluster
...
$PY $CLI/metrics.py "$OUT/17-Experimento-17_03_2026_resultados_modelo_2024_scrape_FULL.csv" "$M"
```

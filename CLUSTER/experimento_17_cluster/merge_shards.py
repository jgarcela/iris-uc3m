...
patron = os.path.join(output_dir, "17-Experimento-17_03_2026_resultados_modelo_2024_scrape_shard*de*.csv")
...
salida = os.path.join(output_dir, "17-Experimento-17_03_2026_resultados_modelo_2024_scrape_FULL.csv")

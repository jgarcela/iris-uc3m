# Experimento 18 (cluster) — comparativa multi-modelo de las 5 variables de sexismo
...
$PY $CLI/metrics.py "$OUT/18-Experimento-18_03_2026_resultados_modelo_2024_scrape_FULL.csv" "$M"
```

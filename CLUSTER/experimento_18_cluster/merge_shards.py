...
patron = os.path.join(output_dir, "18-Experimento-18_03_2026_resultados_modelo_2024_scrape_shard*de*.csv")
...
salida = os.path.join(output_dir, "18-Experimento-18_03_2026_resultados_modelo_2024_scrape_FULL.csv")

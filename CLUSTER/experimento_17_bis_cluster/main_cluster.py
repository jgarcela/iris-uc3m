"""
Experimento 17 bis adaptado para el cluster TSC (fase CLIENTE).
...
pero el experimento_17 compara MODELOS DE API además del Ollama local. Como
...
# ==========================================
def parse_args():
    p = argparse.ArgumentParser(description="Experimento 17 bis - cliente cluster (sharded, multi-proveedor)")
    ...
    p.add_argument("--model", default=os.environ.get("MODELO", "gpt-5-nano"),
...
PREFFIX = "17bis-Experimento-17bis_03_2026"

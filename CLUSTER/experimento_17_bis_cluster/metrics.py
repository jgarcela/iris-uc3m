"""
Métricas del experimento_17 (cluster). Lee el CSV unido (_FULL) de un modelo y
calcula accuracy/kappa/F1 por variable frente al ground truth.

Uso:
    python metrics.py [ruta_csv_FULL] [etiqueta_modelo]

Por defecto lee results/17bis-Experimento-17bis_03_2026_resultados_modelo_2024_scrape_FULL.csv
...
DEFAULT_INPUT = os.path.join(
    BASE_DIR, "results",
    "17bis-Experimento-17bis_03_2026_resultados_modelo_2024_scrape_FULL.csv",
)

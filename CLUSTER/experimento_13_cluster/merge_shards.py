"""Junta los CSV por shard del experimento_13 en un único resultado final."""
import glob
import os
import sys
...
patron = os.path.join(output_dir, "13-Experimento-13_03_2026_resultados_modelo_2024_scrape_shard*de*.csv")
...
salida = os.path.join(output_dir, "13-Experimento-13_03_2026_resultados_modelo_2024_scrape_FULL.csv")

"""Junta los CSV por shard en un único resultado final."""
import glob
import os
import sys
...
patron = os.path.join(output_dir, "12-Experimento-12_03_2026_resultados_modelo_2024_scrape_shard*de*.csv")
...
salida = os.path.join(output_dir, "12-Experimento-12_03_2026_resultados_modelo_2024_scrape_FULL.csv")
